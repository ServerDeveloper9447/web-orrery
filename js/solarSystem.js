...
const starTexture = textureLoader.load("./image/stars.png");
...
/////////////////////////////////////
//NOTE: create planet
const genratePlanet = (size, planetTexture, x, inclination = 0, ring) => {
  ...
  // Create a pivot object to handle inclination
...
const planets = [
  {
    ...genratePlanet(3.2, mercuryTexture, 28, 25),
    rotaing_speed_around_sun: 0.004,
    self_rotation_speed: 0.004,
    inclination: 25
  },
  {
    ...genratePlanet(12, jupiterTexture, 100, 3),
    rotaing_speed_around_sun: 0.002,
    self_rotation_speed: 0.04,
    inclination: 3
  },
  {
    ...genratePlanet(10, saturnTexture, 138, 5, {
      innerRadius: 10,
      outerRadius: 20,
  ...
  {
    ...genratePlanet(7, uranusTexture, 176, 26, {
      innerRadius: 7,
      outerRadius: 12,
...
function animate(time) {
  ...
  planets.forEach(
    ({ pivot, planet, rotaing_speed_around_sun, self_rotation_speed }) => {
      pivot.rotateY(options.speed * rotaing_speed_around_sun);
